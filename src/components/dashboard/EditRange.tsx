...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (logoFile) {
      ...
      // Logo was removed - set to empty string instead of undefined
      logoUrl = "";
    }

    const rangeImageUrls: string[] = [...existingRangeImages];
    ...
    if (deleteVideo && existingVideoUrl) {
      ...
      videoUrl = null; // Set to null instead of undefined
    ...
    const rangeData = {
      ...
      logoUrl: logoUrl || "", // Ensure this is never undefined
      rangeImages: rangeImageUrls || [],
      videoUrl: videoUrl || null, // Ensure this is never undefined
      youtubeUrl: youtubeUrl || null, // Ensure this is never undefined
      pricePerHour: formData.pricePerHour || 0,
      latitude: formData.latitude || null, // Ensure this is never undefined
      longitude: formData.longitude || null, // Ensure this is never undefined
      updatedAt: new Date()
    };
